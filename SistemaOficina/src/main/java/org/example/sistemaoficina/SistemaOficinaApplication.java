...
public class SistemaOficinaApplication {
    ...
    public CommandLineRunner run(FuncionarioService funcionarioService,
        ...
        return args -> {
            ...
            servicoService.criarServico(o1, f1, "Carlos", "11977777777", "Não iniciado", LocalDateTime.now(), null, "Cartão de Crédito");
            servicoService.criarServico(o2, f2, "Ana", "11966666666", "Em andamento", LocalDateTime.now(), null, "Dinheiro");
